    ...
    <header className="fixed top-0 left-0 w-full backdrop-blur-md z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            href="/get-started"
            className="hidden md:block bg-white text-black px-4 py-2 rounded-full hover:bg-gray-200 transition-colors duration-300"
          >
            Get Started
          </Link>
        ...
        <div className="fixed inset-0 bg-black/90 z-40 md:hidden">
          <div className="flex flex-col items-center justify-center h-full space-y-6">
            ...
            <Link
              href="/get-started"
              onClick={toggleMenu}
              className="bg-white text-black px-6 py-3 rounded-full hover:bg-gray-200 transition-colors duration-300"
            >
              Get Started
            </Link>
          </div>
